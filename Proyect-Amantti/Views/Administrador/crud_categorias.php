            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card-header justify-content-center">
                    ...
                    <div class="card-title text-center mb-4 col-12 d-grid justify-content-center">
                        <h2 class="border border-4 border-primary rounded-4 p-2"><strong>CRUD - CATEGORÍAS</strong></h2>
                    </div>
                    <div class="container-fluid mb-5">
                        ...
                        <!-- Tabla de datos -->
                        <table id="table_responsive" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th scope="col">id</th>
                            ...
                            <tbody>
                                ...
                                $sql = $conexion->query(
                                    "SELECT categorias.id, categorias.nombre, parametros.valor AS estado
                                    FROM categorias
