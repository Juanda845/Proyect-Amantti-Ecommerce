            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card-header justify-content-center">
                    ...
                    <div class="card-title text-center mb-4 col-12 d-grid justify-content-center">
                        <h2 class="border border-4 border-primary rounded-4 p-2"><strong>CRUD - USUARIOS</strong></h2>
                    </div>
                    <div class="container-fluid mb-5">
                        ...
                        <table id="table_responsive" class="table table-light table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                // Se corrige aquí la consulta para asegurarse que estamos obteniendo los estados correctamente
                                $sql = $conexion->query(
    ...
    <script>
        $(document).on('click', 'button.btn-danger', function() {
            ...
            function mostrarErrorAlerta() {
                Swal.fire({
                    title: 'Error',
                    text: 'Este usuario ya está desactivado.',
                    icon: 'error',
                });
            }
