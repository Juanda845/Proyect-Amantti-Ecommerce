            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card-header justify-content-center">
                    <div class="card-title text-center col-12 d-grid justify-content-center">
                        <h1 class="border border-4 border-primary rounded-4 p-2"><strong>BIENVENIDO ADMINISTRADOR <span></span><?php echo $nombre; ?></strong></h1>
                    </div>
                    <div class="card-title text-center mb-4 col-12 d-grid justify-content-center">
                        <h2 class="border border-4 border-primary rounded-4 p-2"><strong>CRUD - ESTADOS</strong></h2>
                    </div>
                    <div class="container-fluid">
