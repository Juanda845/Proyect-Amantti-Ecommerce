...
if (strlen($contraseña) < 8 || !preg_match('/[A-Z]/', $contraseña) || !preg_match('/[a-z]/', $contraseña) || !preg_match('/[0-9]/', $contraseña) || preg_match('/[^a-zA-Z0-9]/', $contraseña)) {
    ...
    header("location:../Views/register.php?error=contraseña_invalida&nombres=$nombres&apellidos=$apellidos&correo=$correo&rol_id=$rol_id&estado=$estado");
    exit;
}
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    header("location:../Views/register.php?error=existente&nombres=$nombres&apellidos=$apellidos&correo=$correo&rol_id=$rol_id&estado=$estado");
} else {
